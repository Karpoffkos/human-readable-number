module.exports = function toReadable (number) {
    ...
    let low20 = ["zero", "one", "two","three","four","five","six","seven","eight","nine", 'ten', 'eleven','twelve','thirteen','fourteen','fifteen','sixteen','seventeen','eighteen','nineteen'];
...
/*     console.log(single, low20[single], 8);
    ...
    if (number < 1000){ 
      /*   console.log(17); */
        return number%100 ? (low20[hundred] + " hundred "+ toReadable(number%100)) : (low20[hundred] + " hundred");
    };
